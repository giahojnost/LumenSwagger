...
use LumenSwagger\ServiceProvider as LumenSwaggerServiceProvider;
...
class LumenTestCase extends TestCase
{
    ...
    public function createApplication()
    {
        ...
        $app->register(LumenSwaggerServiceProvider::class);

        $app->router->group(['namespace' => 'LumenSwagger'], function ($route) {
    ...
    {
        return version_compare(config('lumen-swagger.swagger_version'), '3.0', '>=');
    }
    ...
    {
        return config('lumen-swagger.paths.docs').'/api-docs.json';
    }
